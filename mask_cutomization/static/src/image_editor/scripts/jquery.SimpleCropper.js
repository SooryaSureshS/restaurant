...
(function ($) {
    ...
    $.fn.simpleCropper = function (onComplete) {
        ...
        var jcrop_api;
        var bottom_html = "<input type='file' id='fileInput' name='files[]'/ accept='image/*'><canvas id='myCanvas' style='display:none;'></canvas><div id='modal'></div><div id='preview'><div class='buttons' style='bottom: unset;right: -44px;top: 72px;'><div class='cancel'></div><div class='ok'></div></div></div>";
        ...
        function preview() {
            ...
            imageFoo.name = image_filename;
            console.log("filenamememe",image_filename)
