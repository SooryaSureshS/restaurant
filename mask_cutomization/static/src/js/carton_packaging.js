odoo.define('mask_cutomization.carton_packaging', function (require) {
'use strict';
...
publicWidget.registry.carton_packaging = publicWidget.Widget.extend({
    selector: '#carton_packagings',
    events: {
        'input #upload_file_change': '_upload_file_change',
        'click #fetch_upload': '_fetch_upload',
        'click #preview-btn': '_preview_button',
        'click #design_none': '_design_unload_btn',
     ...
     */
    init: function () {
     console.log("*****************product_paffckaging")
    ...
    start: function () {
        ...
        self._rpc({
                    ...
                    if (data['carton_packaging_image']){
                        var img = "data:image/jpeg;base64,"+data['carton_packaging_image']
                        $('#print-2').attr("style",'background-image:url('+img+')');
                        $('#print-2').removeClass('border_none');
                        $('#print-2').removeClass('border_block');
                        $('#print-2').addClass('border_none');
                    }
        });
//        if (package_image) {
...
//                        var package_image = $('#package_image').val();
//                        if (package_image) {
//                            var url_image = window.location.origin+'/web/image?model=sale.order.line&id='+product_line+'&field=carton_packaging_image'
//                            $('#print-2').attr("style",'background-image:url('+url_image+')');
//                        }
//
//            }
//        }else{
//            $('#print-2').attr("style",'background-image:url()');
//        }
...
//                console.log("carton base64",reader.result)
