...
class web_gift_coupon(models.Model):
	...
	def print_report_coupons(self):
		# return self.env['report'].get_action(self, 'website_discount_voucher.report_gift_coupon')
		return self.env.ref('website_discount_voucher.action_report_print_gift_coupon').report_action(self)
	...
	# config_id  =  fields.Many2one('web.coupons.setting', 'Coupon Configuration')
