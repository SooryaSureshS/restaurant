...
class OrganizeTemplate(models.Model):
   _name = 'organize.slot.template'
   _description = "Shift Template"

   role_id = fields.Many2one('organize.role', string="Role")
   ...
   def read_group(self, domain, fields, groupby, offset=0, limit=None, orderby=False, lazy=True):
       res = []
       for data in super(OrganizeTemplate, self).read_group(domain, fields, groupby, offset, limit, orderby, lazy):
