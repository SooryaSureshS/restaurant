odoo.define('organize.GantRow', function (require) {
    'use strict';

    const GantRow = require('backend_gant.GanttRow');
    const StandaloneM2OAvatarEmployee = require('hr.StandaloneM2OAvatarEmployee');

    const OrganizeGantView = GantRow.extend({
        template: 'OrganizeGantView.Row',
