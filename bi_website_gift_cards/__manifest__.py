...
{
	'name' : 'Website Gift Cards in Odoo',
	'version' : '14.0.0.0',
	'summary': 'apps to create gift card and discount voucher odoo shop offer gift card shop gift card shop offer gift card store gift card store discount card store shop new user discount first order offers app Odoo website gift coupon on website coupon discount for shop',
	'category' : 'Website',
	'description': '''
...
This apps helps to create gift card and discount voucher which is going to use for odoo shop
		marketplace gift cards

		giftcards for website 
		webshop giftcards
		webstore giftcards
...
Module to send an email offering discount voucher to customer one week before Birthday and Father's Day. 
Modules provides a feature to send a discount voucher when New user is created.
...
website discount coupon, website gift discount, website discount voucher website coupon discount, website voucher coupon 
...
webshop discount coupon, webshop gift discount, webshop discount voucher, webshop coupon discount, webshop voucher coupon 
...
eCommerce discount coupon, eCommerce gift discount, eCommerce discount voucher, eCommerce coupon discount, eCommerce voucher coupon 
...
Gift Voucher on eCommerce
	...
	'price': 44,
	'currency': 'EUR',
	'depends' : ['base','sale','sale_product_configurator','account','sale_management','website','website_sale','website_discount_voucher'],
	'data': [
		'data/data_view.xml',
		'views/product_gift_card_view.xml',
		'views/product_gift_message_template.xml',
	],
	'auto_install': False,
	'installable': True,
	'live_test_url':'https://youtu.be/xigaf9GTIro',
