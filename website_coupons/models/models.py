...
class Coupon(models.Model):
    ...
    @api.constrains("sunday_available_time_from","sunday_available_time_to","monday_available_time_from","monday_available_time_to",
                    "tuesday_available_time_from","tuesday_available_time_to","wednesday_available_time_from","wednesday_available_time_to"
                    "thursday_available_time_from","thursday_available_time_to","friday_available_time_from","friday_available_time_to",
