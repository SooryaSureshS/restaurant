odoo.define('backend_gant.GanttView', function (require) {
"use strict";

var AbstractView = require('web.AbstractView');
var core = require('web.core');
var GanttModel = require('backend_gant.GanttModel');
var GanttRenderer = require('backend_gant.GanttRenderer');
...
var GanttView = AbstractView.extend({
    ...
    init: function (viewInfo, params) {
        ...
        this.rendererParams.CustomAllTotalRow = arch.attrs.custom_all_total_row || false;
