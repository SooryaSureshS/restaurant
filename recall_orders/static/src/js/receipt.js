odoo.define('recall_orders.receipt', function(require) {
    'use strict';
    ...
    class ReceiptScreenRecall extends PosComponent {
        constructor() {
            super(...arguments);
...
//                    await nextFrame();
    ...
    ReceiptScreenRecall.template = 'ReceiptScreenRecall';

    Registries.Component.add(ReceiptScreenRecall);

    return ReceiptScreenRecall;
});
