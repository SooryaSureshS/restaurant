odoo.define('pos_qty_disable.ProductScreen', function(require) {
    'use strict';
    ...
    const ProductScreens = ProductScreen => class extends ProductScreen {
        constructor() {
            super(...arguments);
...
//            let status = this.showCashBoxOpening()
            this.state = useState({ cashControl: status, numpadMode: '' });
