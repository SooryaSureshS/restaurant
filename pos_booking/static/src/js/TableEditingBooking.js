odoo.define('pos_booking.TableEditingBooking', function(require) {
    'use strict';
    ...
    class TableEditingBooking extends AbstractAwaitablePopup {
        /**
         * @param {Object} props
        ...
        constructor() {
            ...
            this.date_reserved = this.props.reservation.date_reserved.replace(" ", "T");
            this.date_reserved_end = this.props.reservation.date_reserved_end.replace(" ", "T");
    ...
    TableEditingBooking.template = 'TableEditingBooking';
    TableEditingBooking.defaultProps = {
        confirmText: 'Ok',
        cancelText: 'Cancel',
        title: '',
        body: '',
    ...
    Registries.Component.add(TableEditingBooking);

    return TableEditingBooking;
